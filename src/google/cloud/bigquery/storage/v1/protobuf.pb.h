...
class ProtoSchema PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2fprotobuf_2eproto);
    return ::descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2fprotobuf_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline PROTOBUF_NAMESPACE_ID::DescriptorProto* ProtoSchema::release_proto_descriptor() {
  auto temp = unsafe_arena_release_proto_descriptor();
  if (GetArena() != nullptr) {
