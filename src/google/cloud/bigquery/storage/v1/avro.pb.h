...
class AvroRows PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_serialized_binary_rows();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_serialized_binary_rows(
      std::string* serialized_binary_rows);
  private:
...
class AvroSerializationOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~AvroSerializationOptions();
  ...
  inline AvroSerializationOptions* New() const final {
    return CreateMaybeMessage<AvroSerializationOptions>(nullptr);
  }

  AvroSerializationOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline std::string* AvroSchema::unsafe_arena_release_schema() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.bigquery.storage.v1.AvroSchema.schema)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return schema_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void AvroSchema::unsafe_arena_set_allocated_schema(
    std::string* schema) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (schema != nullptr) {
  ...
  schema_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      schema, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.bigquery.storage.v1.AvroSchema.schema)
}
...
inline std::string* AvroRows::unsafe_arena_release_serialized_binary_rows() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.bigquery.storage.v1.AvroRows.serialized_binary_rows)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return serialized_binary_rows_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void AvroRows::unsafe_arena_set_allocated_serialized_binary_rows(
    std::string* serialized_binary_rows) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (serialized_binary_rows != nullptr) {
  ...
  serialized_binary_rows_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      serialized_binary_rows, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.bigquery.storage.v1.AvroRows.serialized_binary_rows)
}
...
inline bool AvroSerializationOptions::_internal_enable_display_name_attribute() const {
  return enable_display_name_attribute_;
}
...
inline void AvroSerializationOptions::_internal_set_enable_display_name_attribute(bool value) {
  ...
  enable_display_name_attribute_ = value;
}
