...
class AvroSerializationOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<AvroSerializationOptions> _instance;
...
static void InitDefaultsscc_info_AvroSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::google::cloud::bigquery::storage::v1::_AvroSerializationOptions_default_instance_;
    new (ptr) ::google::cloud::bigquery::storage::v1::AvroSerializationOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::google::cloud::bigquery::storage::v1::AvroSerializationOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AvroSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AvroSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto[3];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::google::cloud::bigquery::storage::v1::AvroSerializationOptions, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::google::cloud::bigquery::storage::v1::AvroSerializationOptions, enable_display_name_attribute_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 13, -1, sizeof(::google::cloud::bigquery::storage::v1::AvroSerializationOptions)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::google::cloud::bigquery::storage::v1::_AvroSerializationOptions_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_sccs[3] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto = {
  false, false, descriptor_table_protodef_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto, "google/cloud/bigquery/storage/v1/avro.proto", 439,
  &descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_once, descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_sccs, descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto::offsets,
  file_level_metadata_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto, 3, file_level_enum_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto, file_level_service_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto,
};
...
void AvroSerializationOptions::InitAsDefaultInstance() {
}
class AvroSerializationOptions::_Internal {
 public:
};

AvroSerializationOptions::AvroSerializationOptions(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
}
AvroSerializationOptions::AvroSerializationOptions(const AvroSerializationOptions& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  enable_display_name_attribute_ = from.enable_display_name_attribute_;
  // @@protoc_insertion_point(copy_constructor:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
}

void AvroSerializationOptions::SharedCtor() {
  enable_display_name_attribute_ = false;
}

AvroSerializationOptions::~AvroSerializationOptions() {
  // @@protoc_insertion_point(destructor:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void AvroSerializationOptions::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void AvroSerializationOptions::ArenaDtor(void* object) {
  AvroSerializationOptions* _this = reinterpret_cast< AvroSerializationOptions* >(object);
  (void)_this;
}
void AvroSerializationOptions::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void AvroSerializationOptions::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const AvroSerializationOptions& AvroSerializationOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_AvroSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto.base);
  return *internal_default_instance();
}


void AvroSerializationOptions::Clear() {
// @@protoc_insertion_point(message_clear_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* AvroSerializationOptions::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          enable_display_name_attribute_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* AvroSerializationOptions::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // bool enable_display_name_attribute = 1;
  if (this->enable_display_name_attribute() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(1, this->_internal_enable_display_name_attribute(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  return target;
}

size_t AvroSerializationOptions::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  size_t total_size = 0;
...
void AvroSerializationOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const AvroSerializationOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AvroSerializationOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
    MergeFrom(*source);
  }
}

void AvroSerializationOptions::MergeFrom(const AvroSerializationOptions& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  if (from.enable_display_name_attribute() != 0) {
    _internal_set_enable_display_name_attribute(from._internal_enable_display_name_attribute());
  }
}

void AvroSerializationOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void AvroSerializationOptions::CopyFrom(const AvroSerializationOptions& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:google.cloud.bigquery.storage.v1.AvroSerializationOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool AvroSerializationOptions::IsInitialized() const {
  return true;
}

void AvroSerializationOptions::InternalSwap(AvroSerializationOptions* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(enable_display_name_attribute_, other->enable_display_name_attribute_);
}

::PROTOBUF_NAMESPACE_ID::Metadata AvroSerializationOptions::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::google::cloud::bigquery::storage::v1::AvroSerializationOptions* Arena::CreateMaybeMessage< ::google::cloud::bigquery::storage::v1::AvroSerializationOptions >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::bigquery::storage::v1::AvroSerializationOptions >(arena);
}
