 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Reads rows from the stream in the format prescribed by the ReadSession.
      // Each response contains one or more table rows, up to a maximum of 100 MiB
      // per response; read requests which attempt to read individual rows larger
      ...
      virtual void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void CreateReadSession(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::ReadSession* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void SplitReadStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_CreateReadSession : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_CreateReadSession() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::CreateReadSessionRequest, ::google::cloud::bigquery::storage::v1::ReadSession>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::CreateReadSessionRequest, ::google::cloud::bigquery::storage::v1::ReadSession>*>(handler)
    ...
    ExperimentalWithCallbackMethod_ReadRows() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::google::cloud::bigquery::storage::v1::ReadRowsRequest, ::google::cloud::bigquery::storage::v1::ReadRowsResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
  ...
  class ExperimentalWithCallbackMethod_SplitReadStream : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_SplitReadStream() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::SplitReadStreamRequest, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::SplitReadStreamRequest, ::google::cloud::bigquery::storage::v1::SplitReadStreamResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
...
class BigQueryWrite final {
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void CreateWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Appends data to the given stream.
      //
      // If `offset` is specified, the `offset` is checked against the end of
      ...
      #else
      virtual void AppendRows(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::google::cloud::bigquery::storage::v1::AppendRowsRequest,::google::cloud::bigquery::storage::v1::AppendRowsResponse>* reactor) = 0;
      #endif
      // Gets information about a write stream.
      ...
      virtual void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void GetWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Finalize a write stream so that no new data can be appended to the
      // stream. Finalize is not supported on the '_default' stream.
      ...
      virtual void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void FinalizeWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Atomically commits a group of `PENDING` streams that belong to the same
      // `parent` table.
      //
      ...
      virtual void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Flushes rows to a BUFFERED stream.
      //
      // If users are appending rows to BUFFERED stream, flush operation is
      ...
      virtual void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void FlushRows(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    typedef class experimental_async_interface async_interface;
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void CreateWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void CreateWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void AppendRows(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::google::cloud::bigquery::storage::v1::AppendRowsRequest,::google::cloud::bigquery::storage::v1::AppendRowsResponse>* reactor) override;
      #endif
      ...
      void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void GetWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void GetWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::WriteStream* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void FinalizeWriteStream(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void FinalizeWriteStream(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void BatchCommitWriteStreams(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void FlushRows(::grpc::ClientContext* context, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void FlushRows(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
      explicit experimental_async(Stub* stub): stub_(stub) { }
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_CreateWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_CreateWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
    #endif
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response) { return this->CreateWriteStream(context, request, response); }));}
    void SetMessageAllocatorFor_CreateWriteStream(
        ::grpc::experimental::MessageAllocator< ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(0);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_CreateWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CreateWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* CreateWriteStream(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* CreateWriteStream(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_AppendRows : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_AppendRows() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
    #endif
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackBidiHandler< ::google::cloud::bigquery::storage::v1::AppendRowsRequest, ::google::cloud::bigquery::storage::v1::AppendRowsResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context) { return this->AppendRows(context); }));
    }
    ~ExperimentalWithCallbackMethod_AppendRows() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AppendRows(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::google::cloud::bigquery::storage::v1::AppendRowsResponse, ::google::cloud::bigquery::storage::v1::AppendRowsRequest>* /*stream*/)  override {
    ...
    #else
    virtual ::grpc::experimental::ServerBidiReactor< ::google::cloud::bigquery::storage::v1::AppendRowsRequest, ::google::cloud::bigquery::storage::v1::AppendRowsResponse>* AppendRows(
      ::grpc::experimental::CallbackServerContext* /*context*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_GetWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_GetWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
    #endif
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::WriteStream* response) { return this->GetWriteStream(context, request, response); }));}
    void SetMessageAllocatorFor_GetWriteStream(
        ::grpc::experimental::MessageAllocator< ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(2);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest, ::google::cloud::bigquery::storage::v1::WriteStream>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_GetWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* GetWriteStream(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* GetWriteStream(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_FinalizeWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_FinalizeWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(3,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* request, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* response) { return this->FinalizeWriteStream(context, request, response); }));}
    void SetMessageAllocatorFor_FinalizeWriteStream(
        ::grpc::experimental::MessageAllocator< ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(3);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_FinalizeWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FinalizeWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* FinalizeWriteStream(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* FinalizeWriteStream(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_BatchCommitWriteStreams : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_BatchCommitWriteStreams() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(4,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* request, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* response) { return this->BatchCommitWriteStreams(context, request, response); }));}
    void SetMessageAllocatorFor_BatchCommitWriteStreams(
        ::grpc::experimental::MessageAllocator< ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(4);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(4);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_BatchCommitWriteStreams() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status BatchCommitWriteStreams(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* BatchCommitWriteStreams(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* BatchCommitWriteStreams(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_FlushRows : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_FlushRows() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(5,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::FlushRowsRequest, ::google::cloud::bigquery::storage::v1::FlushRowsResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* request, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* response) { return this->FlushRows(context, request, response); }));}
    void SetMessageAllocatorFor_FlushRows(
        ::grpc::experimental::MessageAllocator< ::google::cloud::bigquery::storage::v1::FlushRowsRequest, ::google::cloud::bigquery::storage::v1::FlushRowsResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(5);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(5);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::google::cloud::bigquery::storage::v1::FlushRowsRequest, ::google::cloud::bigquery::storage::v1::FlushRowsResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_FlushRows() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FlushRows(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* FlushRows(
      ::grpc::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* FlushRows(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_CreateWriteStream<ExperimentalWithCallbackMethod_AppendRows<ExperimentalWithCallbackMethod_GetWriteStream<ExperimentalWithCallbackMethod_FinalizeWriteStream<ExperimentalWithCallbackMethod_BatchCommitWriteStreams<ExperimentalWithCallbackMethod_FlushRows<Service > > > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_CreateWriteStream<ExperimentalWithCallbackMethod_AppendRows<ExperimentalWithCallbackMethod_GetWriteStream<ExperimentalWithCallbackMethod_FinalizeWriteStream<ExperimentalWithCallbackMethod_BatchCommitWriteStreams<ExperimentalWithCallbackMethod_FlushRows<Service > > > > > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_CreateWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_CreateWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->CreateWriteStream(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_CreateWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CreateWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::CreateWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_AppendRows : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_AppendRows() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
    ...
    ~ExperimentalWithRawCallbackMethod_AppendRows() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status AppendRows(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::google::cloud::bigquery::storage::v1::AppendRowsResponse, ::google::cloud::bigquery::storage::v1::AppendRowsRequest>* /*stream*/)  override {
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* AppendRows(
      ::grpc::CallbackServerContext* /*context*/)
    #else
    virtual ::grpc::experimental::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* AppendRows(
      ::grpc::experimental::CallbackServerContext* /*context*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_GetWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_GetWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->GetWriteStream(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_GetWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::GetWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::WriteStream* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_FinalizeWriteStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_FinalizeWriteStream() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(3,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->FinalizeWriteStream(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_FinalizeWriteStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FinalizeWriteStream(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FinalizeWriteStreamResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_BatchCommitWriteStreams : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_BatchCommitWriteStreams() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(4,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->BatchCommitWriteStreams(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_BatchCommitWriteStreams() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status BatchCommitWriteStreams(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::BatchCommitWriteStreamsResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_FlushRows : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_FlushRows() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(5,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->FlushRows(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_FlushRows() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FlushRows(::grpc::ServerContext* /*context*/, const ::google::cloud::bigquery::storage::v1::FlushRowsRequest* /*request*/, ::google::cloud::bigquery::storage::v1::FlushRowsResponse* /*response*/) override {
