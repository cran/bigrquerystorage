...
class ArrowSerializationOptionsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ArrowSerializationOptions> _instance;
...
static void InitDefaultsscc_info_ArrowSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::google::cloud::bigquery::storage::v1::_ArrowSerializationOptions_default_instance_;
    new (ptr) ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ArrowSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ArrowSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::google::cloud::bigquery::storage::v1::ArrowSerializationOptions, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::google::cloud::bigquery::storage::v1::ArrowSerializationOptions, buffer_compression_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 13, -1, sizeof(::google::cloud::bigquery::storage::v1::ArrowSerializationOptions)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::google::cloud::bigquery::storage::v1::_ArrowSerializationOptions_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto_sccs[3] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto = {
  false, false, descriptor_table_protodef_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto, "google/cloud/bigquery/storage/v1/arrow.proto", 605,
  &descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto_once, descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto_sccs, descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto::offsets,
  file_level_metadata_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto, 3, file_level_enum_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto, file_level_service_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ArrowSerializationOptions_CompressionCodec_descriptor() {
  ...
  return file_level_enum_descriptors_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto[0];
}
...
constexpr ArrowSerializationOptions_CompressionCodec ArrowSerializationOptions::COMPRESSION_UNSPECIFIED;
constexpr ArrowSerializationOptions_CompressionCodec ArrowSerializationOptions::LZ4_FRAME;
constexpr ArrowSerializationOptions_CompressionCodec ArrowSerializationOptions::ZSTD;
constexpr ArrowSerializationOptions_CompressionCodec ArrowSerializationOptions::CompressionCodec_MIN;
constexpr ArrowSerializationOptions_CompressionCodec ArrowSerializationOptions::CompressionCodec_MAX;
constexpr int ArrowSerializationOptions::CompressionCodec_ARRAYSIZE;
...
void ArrowSerializationOptions::InitAsDefaultInstance() {
}
class ArrowSerializationOptions::_Internal {
 public:
};

ArrowSerializationOptions::ArrowSerializationOptions(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
}
ArrowSerializationOptions::ArrowSerializationOptions(const ArrowSerializationOptions& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  buffer_compression_ = from.buffer_compression_;
  // @@protoc_insertion_point(copy_constructor:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
}

void ArrowSerializationOptions::SharedCtor() {
  buffer_compression_ = 0;
}

ArrowSerializationOptions::~ArrowSerializationOptions() {
  // @@protoc_insertion_point(destructor:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void ArrowSerializationOptions::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void ArrowSerializationOptions::ArenaDtor(void* object) {
  ArrowSerializationOptions* _this = reinterpret_cast< ArrowSerializationOptions* >(object);
  (void)_this;
}
void ArrowSerializationOptions::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ArrowSerializationOptions::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ArrowSerializationOptions& ArrowSerializationOptions::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ArrowSerializationOptions_google_2fcloud_2fbigquery_2fstorage_2fv1_2farrow_2eproto.base);
  return *internal_default_instance();
}


void ArrowSerializationOptions::Clear() {
// @@protoc_insertion_point(message_clear_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ArrowSerializationOptions::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_buffer_compression(static_cast<::google::cloud::bigquery::storage::v1::ArrowSerializationOptions_CompressionCodec>(val));
        } else goto handle_unusual;
        continue;
      default: {
      handle_unusual:
...
::PROTOBUF_NAMESPACE_ID::uint8* ArrowSerializationOptions::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // .google.cloud.bigquery.storage.v1.ArrowSerializationOptions.CompressionCodec buffer_compression = 2;
  if (this->buffer_compression() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      2, this->_internal_buffer_compression(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  return target;
}

size_t ArrowSerializationOptions::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  size_t total_size = 0;
  ...
  if (this->buffer_compression() != 0) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_buffer_compression());
  }
...
void ArrowSerializationOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const ArrowSerializationOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ArrowSerializationOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
    MergeFrom(*source);
  }
}

void ArrowSerializationOptions::MergeFrom(const ArrowSerializationOptions& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  if (from.buffer_compression() != 0) {
    _internal_set_buffer_compression(from._internal_buffer_compression());
  }
}

void ArrowSerializationOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void ArrowSerializationOptions::CopyFrom(const ArrowSerializationOptions& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:google.cloud.bigquery.storage.v1.ArrowSerializationOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ArrowSerializationOptions::IsInitialized() const {
  return true;
}

void ArrowSerializationOptions::InternalSwap(ArrowSerializationOptions* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(buffer_compression_, other->buffer_compression_);
}

::PROTOBUF_NAMESPACE_ID::Metadata ArrowSerializationOptions::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions* Arena::CreateMaybeMessage< ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions >(arena);
}
