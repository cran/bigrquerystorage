...
inline bool TableFieldSchema_Type_Parse(
    const std::string& name, TableFieldSchema_Type* value) {
...
inline bool TableFieldSchema_Mode_Parse(
    const std::string& name, TableFieldSchema_Mode* value) {
...
class TableFieldSchema PROTOBUF_FINAL :
 ...
 public:
  ...
  void clear_default_value_expression();
  const std::string& default_value_expression() const;
  void set_default_value_expression(const std::string& value);
  void set_default_value_expression(std::string&& value);
  void set_default_value_expression(const char* value);
  void set_default_value_expression(const char* value, size_t size);
  std::string* mutable_default_value_expression();
  std::string* release_default_value_expression();
  void set_allocated_default_value_expression(std::string* default_value_expression);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_default_value_expression();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_default_value_expression(
      std::string* default_value_expression);
  private:
  const std::string& _internal_default_value_expression() const;
  void _internal_set_default_value_expression(const std::string& value);
...
inline std::string* TableFieldSchema::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.bigquery.storage.v1.TableFieldSchema.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TableFieldSchema::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.bigquery.storage.v1.TableFieldSchema.name)
}
...
inline std::string* TableFieldSchema::unsafe_arena_release_description() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.bigquery.storage.v1.TableFieldSchema.description)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return description_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TableFieldSchema::unsafe_arena_set_allocated_description(
    std::string* description) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (description != nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.bigquery.storage.v1.TableFieldSchema.description)
}
...
// string default_value_expression = 10 [(.google.api.field_behavior) = OPTIONAL];
inline void TableFieldSchema::clear_default_value_expression() {
  default_value_expression_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TableFieldSchema::default_value_expression() const {
  // @@protoc_insertion_point(field_get:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
  return _internal_default_value_expression();
}
inline void TableFieldSchema::set_default_value_expression(const std::string& value) {
  _internal_set_default_value_expression(value);
  // @@protoc_insertion_point(field_set:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
}
inline std::string* TableFieldSchema::mutable_default_value_expression() {
  // @@protoc_insertion_point(field_mutable:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
  return _internal_mutable_default_value_expression();
}
inline const std::string& TableFieldSchema::_internal_default_value_expression() const {
  return default_value_expression_.Get();
}
inline void TableFieldSchema::_internal_set_default_value_expression(const std::string& value) {
  
  default_value_expression_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TableFieldSchema::set_default_value_expression(std::string&& value) {
  
  default_value_expression_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
}
inline void TableFieldSchema::set_default_value_expression(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  default_value_expression_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
}
inline void TableFieldSchema::set_default_value_expression(const char* value,
    size_t size) {
  
  default_value_expression_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
}
inline std::string* TableFieldSchema::_internal_mutable_default_value_expression() {
  
  return default_value_expression_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TableFieldSchema::release_default_value_expression() {
  // @@protoc_insertion_point(field_release:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
  return default_value_expression_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TableFieldSchema::set_allocated_default_value_expression(std::string* default_value_expression) {
  if (default_value_expression != nullptr) {
    
  } else {
    
  }
  default_value_expression_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), default_value_expression,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
}
inline std::string* TableFieldSchema::unsafe_arena_release_default_value_expression() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.bigquery.storage.v1.TableFieldSchema.default_value_expression)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return default_value_expression_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TableFieldSchema::unsafe_arena_set_allocated_default_value_expression(
    std::string* default_value_expression) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (default_value_expression != nullptr) {
  ...
  default_value_expression_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      default_value_expression, GetArena());
